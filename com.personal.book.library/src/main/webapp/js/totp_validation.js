var totpApplication = angular.module('TOTPApplication', []);

totpApplication.controller('TOTPCtrl', ['$scope', '$rootScope', '$location', '$http', '$window', function($scope, $rootScope, $location, $http, $window) {
    
	$scope.otpCode = '';
	
	$scope.validate = function() {
		
		$http.post('http://localhost:8090/com.personal.book.library/validate?otp_code=' + $scope.otpCode)
